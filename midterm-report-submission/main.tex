...
%  HOW TO COMPILE
%  --------------
%  1. Download the CVPR 2024 author kit:
%       https://github.com/cvpr-org/author-kit
%     Copy cvpr.sty (and eso-pic.sty if present) into this folder.
%  2. pdflatex main.tex
%     bibtex   main
%     pdflatex main.tex
%     pdflatex main.tex
...
DINO~\cite{groundingdino} and OWLv2~\cite{owlv2}; we chose
OWL-ViT for its straightforward HuggingFace integration and reliable
...
larger count.
This five-line OpenCV step needs no learnable parameters.
